...
namespace Datos
{
    public class CategoryDAO
    {
        ...
        public int actualizar(Category categoria)
        {
            ...
            if (Conexion.Conectar())
            {
                ...
                {
                    //Crear la sentencia a ejecutar (INSERT)
                    String select = "UPDATE CATEGORIES SET CATEGORYNAME = @nombre WHERE CATEGORYID = @id; " +
                        "UPDATE CATEGORIES SET DESCRIPTION = @descripcion WHERE CATEGORYID = @id;";
